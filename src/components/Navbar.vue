<template>
  <header class="flex flex-col gap-2 p-4 border-b border-gray-200 bg-white">
    <!-- Logo + Title -->
...
// ambil nama route sebagai breadcrumb
const currentPage = computed(() => route.name || "Halaman")
</script>
